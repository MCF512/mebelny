    ...
    <MyContainer>
      <ul className={styles.advantages}>
        <li className={styles.item}>
          ...
          Мы предлагаем
          Вам широкий ассортимент мебельной продукции
          по выгодным ценам самых различных производителей: Сходня-1 (STP), Боровичи-мебель, Сивилия, Олник, ИЖ-Мебель и многих других. Продажа производится
